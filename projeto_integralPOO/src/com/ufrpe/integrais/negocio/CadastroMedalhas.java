...
public class CadastroMedalhas {
    ...
    public Medalha procurarMedalha(String especificacao) throws ObjetoNaoExistenteExcepition{
   ...
   public void removerMedalha(String especificacao)throws ObjetoNaoExistenteExcepition{
   ...
   public void atualizarMedalha(String especificacao, Medalha novo)throws ObjetoNaoExistenteExcepition{
		
		Medalha retorno = repositorioMedalhas.procurar(especificacao);
		
		if(retorno!= null){
			
			repositorioMedalhas.getListaMedalhas().set(repositorioMedalhas.getListaMedalhas().indexOf(retorno),novo);
			RepositorioMedalhas.salvarNoArquivo();
